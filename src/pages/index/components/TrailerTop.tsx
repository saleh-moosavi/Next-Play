...
export default function TrailerTop() {
  return (
    <div className="bg-white/5 dark:bg-black/10 rounded-2xl overflow-hidden">
      <div className="w-full mb-3 overflow-hidden rounded-2xl">
        <VideoPlayer />
      </div>
      <div className="text-white dark:text-gray-900 text-right p-5">
        <h2 className="text-lg font-semibold mb-2">
          تریلر جذاب بازی Call Of Duty Mobile
        </h2>
        <p className="text-xs font-semibold text-gray-300 dark:text-gray-700 leading-6 text-justify">
        ...
        <hr className="my-5 opacity-20 dark:border-gray-900" />
        <article className="flex justify-between items-center">
          <section className="text-white flex gap-x-10">
            <div className="text-xs flex gap-x-2 items-center cursor-pointer dark:text-gray-900 hover:text-stone-300 dark:hover:text-stone-500 transition-all duration-700">
            ...
            <div className="flex gap-x-3 items-center *:cursor-pointer *:dark:text-gray-800">
          ...
          <button className="bg-white/30 dark:bg-black/30 p-2 dark:text-white rounded-md hover:bg-purple-500 transition-all duration-700">
