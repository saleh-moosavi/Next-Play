  ...
  return (
    <div className="grid grid-cols-5 w-full gap-x-2 items-center bg-gray-700 dark:bg-gray-300 hover:bg-purple-900/40 transition-all duration-700 p-2 rounded-xl text-white group">
      ...
      <article className="col-span-3 flex flex-col items-start justify-between">
        ...
        <p className="text-[.7rem] text-gray-400 dark:text-gray-600 flex items-center gap-x-2 group-hover:text-purple-300 group-hover:dark:text-purple-100 transition-all duration-700">
          <span className="w-[.4rem] h-[.4rem] bg-orange-500 group-hover:bg-purple-400 group-hover:dark:bg-purple-700 transition-all duration-700 inline-block rounded-full"></span>
          {article.views} نفر این مقاله را خواندند
        </p>
        <button className="text-[.6rem] font-semibold bg-gray-800 dark:bg-gray-500 group-hover:bg-purple-600 transition-all duration-700 px-4 py-1 rounded-md mt-1">
          مشاهده مقاله
        </button>
      </article>
    </div>
